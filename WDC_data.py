...
class WdcDataset(Dataset):
    def __init__(self, type='train', aug=False):
        super(WdcDataset, self).__init__()
    ...
    def generateTrain(self):
        ...
        hrhsi = sio.loadmat("/home/s-zhangbd/code/Data/H_M_P/WCTDC/train/train_data.mat")['gt']
        lrhsi = sio.loadmat("/home/s-zhangbd/code/Data/H_M_P/WCTDC/train/train_data.mat")['hsi']
        hrmsi = sio.loadmat("/home/s-zhangbd/code/Data/H_M_P/WCTDC/train/train_data.mat")['msi']
        pan = sio.loadmat("/home/s-zhangbd/code/Data/H_M_P/WCTDC/train/train_data.mat")['pan']
    ...
    def generateTest(self):
        ...
        hrhsi = sio.loadmat("/home/s-zhangbd/code/Data/H_M_P/WCTDC/test/test_data.mat")['gt']
        lrhsi = sio.loadmat("/home/s-zhangbd/code/Data/H_M_P/WCTDC/test/test_data.mat")['hsi']
        hrmsi = sio.loadmat("/home/s-zhangbd/code/Data/H_M_P/WCTDC/test/test_data.mat")['msi']
        pan = sio.loadmat("/home/s-zhangbd/code/Data/H_M_P/WCTDC/test/test_data.mat")['pan']
