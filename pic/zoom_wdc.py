...
def save_img(image_path,path2):
    ...
    # red_box = (369* 160 //256, 369* 132//256, 369* 15 //256, 369* 15 //256) # 红框坐标，进一步向右下方移动
    # print(red_box)(230, 190, 21, 21)
    # red_box = (220, 180, 26, 26) # (230, 190, 20, 20)


    red_box = (158,138,26,26) #(190, 180, 20, 20)  误差图像坐标


    # red_box = (304 * 158 // 369, 304 * 138 // 369, 304 * 26 // 369,
               # 304 * 26 // 369)  # 21  #(304*  190 //369,304*  180  //369,304*  26  //369,304*  26  //369)   #####伪彩色图像
    # red_box = (304*  194 //369,304*  186  //369,304*  26  //369,304*  26  //369) #21  #(304*  190 //369,304*  180  //369,304*  26  //369,304*  26  //369)
...
if __name__ == '__main__':
    index = ['ssr', 'hsr','scp', 'hyper', 'hmp', 'dsp', 'psrt', 'mimo', 'dt3', 'pmi', 'our', 'gt','dim','dpf']
    # index = ['dim','dpf']
    import os
    for i in index:
        img = os.path.join(r"H:\work2\new_hsi_msi_pan\pic_false_color\WDC\error2\0", str(i)+'.png')  ####pic2  error2
        # print(img)
        path2 = os.path.join(r"H:\work2\new_hsi_msi_pan\pic_false_color\WDC\error2\0_z", str(i)+'.png')
        save_img(img,path2)