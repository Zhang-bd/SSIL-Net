...
def save_img(image_path,path2):
    ...
    # red_box = (129, 151, 21, 21) # error 129 151 21 21
    # red_box = (480* 129 //369,480* 151 //369,480* 21 //369,480* 21 //369)  # pic
    # red_box = (191, 160, 21, 21)  # error
    # red_box = (480 * 191 // 369, 480 * 160 // 369, 480 * 21 // 369, 480 * 21 // 369)  # pic
    # green_box = (100, 70, 100, 80)

    red_box =(143,191,27,27)
    # red_box = ( 480 * 143 //369,480 *  191//369,480 *  27//369,480 *  27//369) #pic
    # red_box = (480 * 110 // 369, 480 * 147 // 369, 480 * 21 // 369, 480 * 21 // 369)  # error 143 191 27 27
...
if __name__ == '__main__':
    index = ['ssr', 'hsr','scp', 'hyper', 'hmp', 'dsp', 'psrt', 'mimo', 'dt3', 'pmi', 'our', 'gt']
    import os
    for i in index:
        img = os.path.join(r"H:\work2\new_hsi_msi_pan\pic_false_color\Real\error3", str(i)+'.png')
        # print(img)
        path2 = os.path.join(r"H:\work2\new_hsi_msi_pan\pic_false_color\Real\error3_z", str(i)+'.png')
        save_img(img,path2)