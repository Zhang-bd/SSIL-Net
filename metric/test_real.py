...
def show(data):
    ...
    plt.axis('off')  # 不显示坐标轴
    # plt.savefig(r'H:\work2\结果\Ours\pic_{}.png'.format(i + 1), bbox_inches='tight', pad_inches=0)
    plt.show()

if __name__ == '__main__':
    import scipy.io as sio

    im_gt = sio.loadmat(r"../Real\data2\test_data.mat")['gt'] # Cave  (12,512,512,31)

    # im_out = sio.loadmat(r"H:\work2\结果\result_real\ssr_real_best.mat")['output']  # ssrnet
    # im_out = sio.loadmat(r"H:\work2\结果\result_real\hsr_real_psnr.mat")['output']  #  hsrnet
    # im_out = sio.loadmat(r"H:\work2\结果\result_real\hyper_real_951.mat")['output']  # hypernet

    # im_out = sio.loadmat(r"H:\work2\结果\Hyper\hyper2\hyper_real9_1.mat")['output']  # hyper new

    # im_out = sio.loadmat(r"H:\work2\结果\result_real\hmp_real_new_1.mat")['output']  #  hmpnet
    # im_out = sio.loadmat(r"H:\work2\结果\result_real\dsp_real_best.mat")['output']  #  dspnet
    # im_out = sio.loadmat(r"H:\work2\结果\result_real\psrt_real_best.mat")['output']  #  psrt
    # im_out = sio.loadmat(r"H:\work2\结果\result_real\MIMO_hmp_real_best.mat")['output']  #  mimo-sst
    # im_out = sio.loadmat(r"H:\work2\结果\result_real\3dt_hmp_real_91.mat")['output']  # Cave 3dt
    # im_out = sio.loadmat(r"H:\work2\结果\result_real\ours_model910_real_best.mat")['output']  # Cave ours

    # im_out = sio.loadmat(r"H:\work2\结果\PMII\result_hmp\PMI_real_3_2_50.mat")['output']  # PMI real
    # im_out = sio.loadmat(r"H:\work2\结果\DPFormer\real_2.mat")['output']
    # im_out = sio.loadmat(r"H:\work2\结果\SCPNet\out\scp_real.mat")['output']
    # im_out = sio.loadmat(r"H:\work2\结果\Ours_dc\m2\m2_real_psnr_.mat")['output']  # M2
    # print(np.max(im_out),np.min(im_out))
    im_out = sio.loadmat(r"H:\work2\结果\DIM\")['output']
