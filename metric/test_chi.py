...
if __name__ == '__main__':
    ...
    im_gt = sio.loadmat(r"H:\work2\测试数据\test.mat")['test']  # Chikusei
    methods = {
        ...
        "DIM-HMPF":sio.loadmat(r"H:\work2\结果\DIM\chi_2.mat")['output'],
        "Ours": sio.loadmat(r"H:\work2\结果\消融\m2_psnr.mat")['output']
        # sio.loadmat(r"H:\work2\结果\Ours\new_model9_10_830.mat")['output'][n]
    }
