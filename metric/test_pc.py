...
if __name__ == '__main__':
    ...
    im_gt = sio.loadmat(r"../PC\data4\test_gt.mat")['gt'] # PC  (3, 256, 256, 93)

    # im_out = sio.loadmat(r"H:\work2\结果\result_pc\ssr_pc_best.mat")['output']  # PC ssrnet
    # im_out = sio.loadmat(r"H:\work2\结果\result_pc\hsr_pc_psnr.mat")['output']  # PC hsrnet
    # im_out = sio.loadmat(r"H:\work2\结果\result_pc\hyper_PC_551.mat")['output']  # PC hypernet

    # im_out = sio.loadmat(r"H:\work2\结果\Hyper\hyper2\hyper_PC_551.mat")['output']  # PC hypernet

    # im_out = sio.loadmat(r"H:\work2\结果\result_pc\hmp_pc_new_1.mat")['output']  # PC hmpnet
    # im_out = sio.loadmat(r"H:\work2\结果\result_pc\dsp_pc_best.mat")['output']  # PC dspnet
    # im_out = sio.loadmat(r"H:\work2\结果\result_pc\psrt_pc_1520.mat")['output']  # PC psrt
    # im_out = sio.loadmat(r"H:\work2\结果\result_pc\MIMO_hmp_pc_best.mat")['output']  # PC mimo-sst
    # im_out = sio.loadmat(r"H:\work2\结果\result_pc\3dt_hmp_pc_.mat")['output']  # PC 3dt
    # im_out = sio.loadmat(r"H:\work2\结果\result_pc\pc_model8_13_best.mat")['output']  # PC ours

    # im_out = sio.loadmat(r"H:\work2\结果\PMII\result_hmp\PMI_pc_1.mat")['output']  # PMI pc
    # im_out = sio.loadmat(r"H:\work2\结果\SCPNet\out\scp_pc.mat")['output']
    im_out = sio.loadmat(r"H:\work2\结果\DPFormer\pc_1.mat")['output']
    # im_out = sio.loadmat(r"H:\work2\结果\DIM\pc_2.mat")['output']
    # im_out = sio.loadmat(r"H:\work2\结果\Ours_dc\m2\m2_pc_psnr.mat")['output']  # M2
