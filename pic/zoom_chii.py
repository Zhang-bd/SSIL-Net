...
def save_img(image_path,path2):
    ...
    # red_box = (256* 141 //369, 256* 121//369, 256* 30 //369, 256* 30 //369) # 红框坐标，进一步向右下方移动
    # red_box = (141,121,30,30)

    # red_box = (256 * 80 // 369, 256 * 204 // 369, 256 * 30 // 369, 256 * 30 // 369)  # 红框坐标，进一步向右下方移动
    red_box =  (80,204,30,30)
...
if __name__ == '__main__':
    ...
    import os
    for i in index:
        img = os.path.join(r"H:\work2\new_hsi_msi_pan\pic_false_color\CHI\error2\0", str(i)+'.png')
        # print(img)
        path2 = os.path.join(r"H:\work2\new_hsi_msi_pan\pic_false_color\CHI\error2\0_z", str(i)+'.png')
        save_img(img,path2)